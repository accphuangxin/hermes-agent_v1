...
uv pip install --python $PythonExe "$ProjectRoot[messaging,cron,cli,mcp,honcho,acp,bedrock,mistral,dingtalk,feishu,google,homeassistant,sms,slack,tts-premium,web]"
